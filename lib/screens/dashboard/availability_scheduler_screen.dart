...
class _AvailabilitySchedulerScreenState
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: Text('Failed to load chargers: $e', style: const TextStyle(color: _danger)),
          ),
        );
      }
    }
    ...
    try {
        ...
        const SnackBar(
          ...
          content: Row(
            children: [
              ...
              SizedBox(width: 8),
              Text("Schedule updated successfully", style: TextStyle(color: _text)),
            ],
          ),
        ),
      );
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            backgroundColor: _panel,
            content: Text('Failed to update schedule: $e', style: const TextStyle(color: _danger)),
          ),
        );
      }
    } finally {
  ...
  void _showPriceEditDialog(int index) {
    ...
    final controller = TextEditingController(text: slot.pricePerKwh.toStringAsFixed(2));
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              if (newPrice != null && newPrice > 0) {
                setState(() {
                  _editableSlots[index] = slot.copyWith(pricePerKwh: newPrice);
                });
              ...
              child: FutureBuilder<List<AvailabilitySlot>>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (_editableSlots.isEmpty) {
                    return const Center(
                      child: Text('No slots available for this charger.',
        ...
        children: [
          ...
          IconButton(
            ...
            icon: Container(
              ...
              child: const Icon(Icons.refresh_rounded, color: _cyan, size: 18),
            ),
          ),
        ],
      ),
        ...
        children: _chargers.map((charger) {
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isSelected ? _cyan.withValues(alpha: 0.15) : _panel,
                borderRadius: BorderRadius.circular(10),
                border: Border.all(
                  color: isSelected ? _cyan : _cyan.withValues(alpha: 0.1),
                ),
              ),
              child: Row(
                children: [
                  Icon(Icons.ev_station_rounded, size: 16, color: isSelected ? _cyan : _muted),
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isSelected ? _lime : Colors.white.withValues(alpha: 0.05),
                ),
              ),
              child: Column(
  ...
  Widget _buildSlotTile(AvailabilitySlot slot, int index) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isAvailable
              ? (slot.isPeak ? _amber.withValues(alpha: 0.3) : _cyan.withValues(alpha: 0.15))
